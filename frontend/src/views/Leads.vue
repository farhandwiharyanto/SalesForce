  ...
  <div class="pb-12 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
      ...
      <div class="flex items-center gap-3">
        <button v-if="authStore.hasAction('Leads', 'create')" @click="showImportModal = true" class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 px-4 py-2.5 rounded-xl font-bold shadow-sm transition-all flex items-center gap-2">
        ...
        <button v-if="authStore.hasAction('Leads', 'create')" @click="openAddModal" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl shadow-md transition-all font-semibold flex items-center gap-2 transform hover:-translate-y-0.5">
              ...
              <tbody class="divide-y divide-gray-100">
                ...
                <tr v-for="lead in leads" :key="lead.id" class="hover:bg-gray-50 transition-colors group">
                  ...
                  <td class="py-4 px-6 text-right flex justify-end gap-2">
                    <button v-if="authStore.hasAction('Leads', 'edit')" @click="openEditModal(lead)" class="text-xs font-bold text-blue-600 bg-blue-50 hover:bg-blue-100 px-3 py-1.5 rounded-lg transition-colors border border-blue-200 shadow-sm inline-flex items-center">
                      Edit
                    </button>
